...
APERTURAS_20 = {
    "Dos aberturas (marco + círculo) — pto 1": {
        ...
        "usa_escala": True,
        "sliders": [
            ("a", "a ext. ancho (mm)", 0.001, 20.0, 0.120, 1e-3, "{:.3f}"),
            ("b", "b ext. alto (mm)", 0.001, 20.0, 0.160, 1e-3, "{:.3f}"),
            ("c", "c int. ancho (mm)", 0.0, 15.0, 0.060, 1e-3, "{:.3f}"),
            ("d", "d int. alto (mm)", 0.0, 15.0, 0.090, 1e-3, "{:.3f}"),
            ("R", "R radio (mm)", 0.001, 15.0, 0.080, 1e-3, "{:.3f}"),
            ("D", "D separación (mm)", 0.0, 40.0, 0.400, 1e-3, "{:.3f}"),
    ...
    "Rectángulo rotado — pto 3": {
        ...
        "usa_escala": True,
        "sliders": [
            ("a", "a lado en x (mm)", 0.001, 20.0, 0.010, 1e-3, "{:.3f}"),
            ("b", "b lado en y (mm)", 0.001, 20.0, 0.005, 1e-3, "{:.3f}"),
    ...
    "Cruz — pto 5": {
        ...
        "usa_escala": True,
        "sliders": [
            ("L", "L largo total (mm)", 0.001, 30.0, 0.200, 1e-3, "{:.3f}"),
            ("a", "a ancho brazo (mm)", 0.001, 10.0, 0.050, 1e-3, "{:.3f}"),
            ("lam", "λ (nm)", 380.0, 1000.0, 633.0, 1e-9, "{:.0f}"),
            ("z", "z (m)", 0.05, 5.0, 1.0, 1.0, "{:.2f}"),
    ...
    "Dos semicírculos — pto 9": {
        ...
        "sliders": [
            ("r1", "r1 superior (mm)", 0.0, 5.0, 2.0, 1e-3, "{:.3f}"),
            ("r2", "r2 inferior (mm)", 0.0, 5.0, 1.41421, 1e-3, "{:.3f}"),
    ...
    "Doble cuadrado — pto 14": {
        ...
        "usa_escala": True,
        "sliders": [
            ("a", "a lado peq (mm)", 0.001, 8.0, 0.050, 1e-3, "{:.3f}"),
            ("lam", "λ (nm)", 380.0, 1000.0, 633.0, 1e-9, "{:.0f}"),
    ...
    "Doble círculo (Fh+Fr) — pto 19": {
        ...
        "sliders": [
            ("r1", "r1 3 cuad. (mm)", 0.2, 3.0, 1.0, 1e-3, "{:.3f}"),
            ("r2", "r2 sup-der (mm)", 0.2, 4.0, 1.41, 1e-3, "{:.3f}"),
            ("lam", "λ (nm)", 380.0, 1000.0, 500.0, 1e-9, "{:.0f}"),
